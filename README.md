...
- Routes below 950 miles
- Routes close to 950 miles
...
```bash
python manage.py test planner.tests.test_hos.HOSPlannerTests.test_fuel_stop_is_added_before_950_miles
```
...
```text
Internal Fuel Threshold = 950 miles
```
...
The 950-mile threshold intentionally provides a 50-mile buffer against the assessment's 1,000-mile maximum interval.
...
The implementation validates the primary assessment requirements through automated tests and generated itinerary output.
...
| Current → Pickup → Drop-off | Implemented |
| 11-hour driving limit | Implemented |
| 14-hour driving window | Implemented |
| 30-minute break | Implemented |
| 10-hour off-duty reset | Implemented |
| 70-hour / 8-day cycle | Implemented |
